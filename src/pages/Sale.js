        ...
        <div className="tanlanganMahsulotlar">
          ...
          {selectedItems.length > 0 && (
            <>
              ...
              {confirmedTable ? (
            <button className="tasdiqlashBtn">
              <Link to="/tolanganSumma">Tasdiqlandi va To‘landi</Link>
            </button>
             ) : (
            <button
              className="tasdiqlashBtn disabledShake"
              disabled
              title="Avval stol raqamini tasdiqlang"
            >
